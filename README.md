...
当前已完成 **Round 16 — 3层分离**（2026-08-03）：**[R] 实验确证的物理实在**（9组，附实验/精度/文献）→ **[L] 已确证的物理定律**（7组，43条推导）→ **[论证] 论证工具**（数学≠实在）。不经实验验证的 = [假说]。空缺占位标记未知。路径积分预设时空——不能推导时空。Wigner 分类：粒子是对称群表示标签，非基本实体。43 条推导链可追溯至 [R]。
